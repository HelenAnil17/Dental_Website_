                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-7 col-md-6">
                        <div className="appointment-form-area">
                            ...
                            title="Care that Nurtures Inside and Out"
                            description="At our practice, providing exceptional care is our pleasure. We believe in holistic dental health that enhances your well-being from the inside out. With personalized treatments and compassionate service, we ensure every visit leaves you feeling cared for and confident in your smile. Experience the difference of comprehensive dental care that prioritizes your overall health and happiness."/>
