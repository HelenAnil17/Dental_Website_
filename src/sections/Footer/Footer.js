            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-6 col-md-5">
                        ...
                        <p>"Our state-of-the-art facility and experienced team ensure that every patient receives personalized, high-quality dental care tailored to their unique needs."</p>
        ...
        <li><a href="https://www.instagram.com" target="_blank" rel="noopener noreferrer"><FaInstagram /></a></li>
                ...
                {/* <div className="copyright-area">
                    <div className='copy-text'>
                        <p>&copy; Inside out. All Right Reserved</p>
                    </div>  
